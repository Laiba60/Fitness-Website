  ...
  return (
    ...
    > 
      ...
      <div className="relative z-10 max-w-4xl  px-6 md:px-12 pt-32 md:pt-40 text-center md:text-left">
        ...
        <span className="text-[#A58120] font-semibold uppercase">
        ...
        <Link
      to="/contact"
        className="inline-block mt-8 bg-linear-to-b from-[#A58120] to-black text-white px-8 py-4 rounded-full font-semibold transition transform hover:-translate-y-1 shadow-lg hover:shadow-xl"
        >
       Book Appointment
      </Link>
      </div>
